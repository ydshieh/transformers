...
class ModelTesterMixin:
    ...
    def check_pt_tf_models(self, tf_model, pt_model, pt_inputs_dict, context=None, results=None):
    ...
    def test_pt_tf_model_equivalence(self):
        ...
        for model_class in self.all_model_classes:
            ...
            for _ in range(num_iter):
                ...
                self.check_pt_tf_models(tf_model, pt_model, pt_inputs_dict, context="without_labels_mem", results=results)
                # check with `labels`
                if pt_inputs_dict_with_labels:
                    self.check_pt_tf_models(tf_model, pt_model, pt_inputs_dict_with_labels, context="with_labels_mem", results=results)
                ...
                # Original test: check without `labels`
                self.check_pt_tf_models(tf_model, pt_model, pt_inputs_dict, context="without_labels_disk", results=results)
                # check with `labels`
                if pt_inputs_dict_with_labels:
                    self.check_pt_tf_models(tf_model, pt_model, pt_inputs_dict_with_labels, context="without_labels_disk", results=results)
